...
const indicatorOptions = [
  ...
  { value: 'operating_profit', label: '经营利润', note: '毛利润-销售费用-管理费用-研发费用-财务费用+权益性投资损益，衡量所有经营相关的利润，稳定趋升，越高越好', unit: '亿元', isPercent: false, dualColor: true },
  { value: 'hard_profit', label: '硬朗度利润', note: '经营现金流净额-资本开支，衡量企业自由现金流，越高越好', unit: '亿元', isPercent: false, dualColor: true },
  { value: 'total_profit', label: '税前利润', note: '利润总额，包括经营利润与非经常性损益，是不同类资产之间比价的桥梁', unit: '亿元', isPercent: false, dualColor: true },
  { value: 'parent_net_profit', label: '归母净利润', note: '归属母公司股东的全部净利润，稳定趋升，越高越好', unit: '亿元', isPercent: false, dualColor: true },
  { value: 'deducted_net_profit', label: '扣非净利润', note: '扣除非经常损益后的净利润，稳定趋升，越高越好', unit: '亿元', isPercent: false, dualColor: true },
